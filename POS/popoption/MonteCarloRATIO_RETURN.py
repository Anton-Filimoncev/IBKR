...
def monteCarlo_return(underlying, rate, sigma_long, sigma_short1, sigma_short2,
                                                            days_to_expiration,
                                                            closing_days_array, trials, initial_credit, min_profit,
                                                            strikes, bsm_func, yahoo_stock):
    ...
    sigma_short1, sigma_short2, sigma_long = sigma_short1 / 100, sigma_short2 / 100, sigma_long / 100
    rate = rate / 100
    ...
    for c in range(trials):
        ...
        for r in range(max_closing_days + 1):
            ...
            debit = bsm_func(stock_price, strikes, rate, time_fraction, sigma_long, sigma_short1, sigma_short2)
