...
for tick in ticker_list:
    ...
    try:
        ...
        current_price, current_iv_percentile = get_ib_data(tick, yahoo_df)
    ...
    #
        ...
        proba_below = get_proba_below(needed_put_short, needed_put_long, current_price, hist_vol)
