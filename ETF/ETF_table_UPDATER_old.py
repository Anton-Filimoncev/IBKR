...
def max_pain(tick, ib):
    ...
    limit_date_max = datetime.datetime.now() + relativedelta(days=+100)
...
for i in range(len(worksheet_df_len)):
    ...
    limit_date_min_1 = datetime.datetime.now() + relativedelta(days=+25)
    limit_date_max_1 = datetime.datetime.now() + relativedelta(days=+55)
    limit_date_min_2 = datetime.datetime.now() + relativedelta(days=+65)
